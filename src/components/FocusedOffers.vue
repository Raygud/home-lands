                    ...
                    <ol>
                        ...
                        <li>
                            <ol>
                                ...
                                <li
                                    v-bind:style="{ 'background-color': energy.find(item => item.value === offer.energy_label_name).color }">
                                    {{ offer.energy_label_name }}</li>
                                <li>værelser {{ offer.num_rooms }},</li>
                                <li>{{ offer.floor_space }} m&sup2;</li>
                                <li>{{ offer.price.substr(0, 1) }}.{{ offer.price.substr(1, 3) }}.{{
                                    offer.price.substr(4, offer.price.length)
                                }} DKK</li>
                            </ol>
